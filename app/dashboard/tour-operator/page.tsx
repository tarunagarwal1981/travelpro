...
import CreatePackageModal from '../../../src/components/forms/create-package-modal'
...
export default function TourOperatorDashboard() {
  ...
  const [showNewPackageAlert, setShowNewPackageAlert] = useState(false)
  ...
  const handleCreatePackage = (newPackageData: any) => {
    ...
    setShowNewPackageAlert(true)
    setTimeout(() => setShowNewPackageAlert(false), 5000)
  }
    ...
    <>
      ...
      {showNewPackageAlert && (
        <div style={{
          ...
          <div>
            <p style={{ margin: 0, fontWeight: '600' }}>Package Created Successfully! 🎉</p>
            <p style={{ margin: 0, fontSize: '0.875rem', opacity: 0.9 }}>Your new package is now live and ready for bookings.</p>
          </div>
        </div>
      )}
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                  <Button 
                    ...
                    style={{ backgroundColor: 'white', color: '#667eea', border: 'none' }}
